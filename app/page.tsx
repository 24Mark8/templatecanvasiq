export default function Home() {
  ...
  <div className="mt-12 grid gap-8 text-center md:grid-cols-4">
    <div>
      <h3 className="text-5xl font-extrabold text-blue-700">24+</h3>
    ...
    <div>
      <h3 className="text-5xl font-extrabold text-blue-700">1M+</h3>
      <p className="mt-2 text-slate-600">Records Analysed</p>
    </div>

    <div>
      <h3 className="text-5xl font-extrabold text-blue-700">24/7</h3>
      <p className="mt-2 text-slate-600">Decision Support</p>
    </div>
  </div>
</section>
          </div><div className="mt-12 flex flex-wrap gap-3">
