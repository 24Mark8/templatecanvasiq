    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        ...
        <p className="mt-6 max-w-3xl text-xl leading-8 text-slate-600">
          A ready-to-use Power BI solution for turning Pressure Injury
          incident data into structured intelligence.
        </p>
      </section>
          ...
          <div className="grid gap-10 md:grid-cols-2">
            ...
            <article className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
              <img
                ...
                alt="Pressure Injury Intelligence dashboard"
      ...
      <section className="bg-blue-700 py-20">
        <div className="mx-auto max-w-4xl px-6 text-center text-white">
          ...
          <a
            href="/toolkit"
            className="mt-8 inline-block rounded-xl bg-white px-7 py-3 font-semibold text-blue-700 hover:bg-slate-100"
          >
            Explore the Toolkit
          </a>
